...
export const metadata: Metadata = {
  title: 'Web Design & SEO Services in Australia | Sydney, Melbourne, Brisbane | Scale With Destiny',
  description: 'Professional web design, SEO optimization, and business setup for Australian businesses in Sydney, Melbourne, Brisbane, Perth, Adelaide, Gold Coast. Get a free website audit today. Trusted by businesses across Australia.',
  keywords: 'web design Australia, SEO services Australia, Sydney web designer, Melbourne SEO expert, Brisbane digital agency, Perth web development, Adelaide SEO, Australian business website, local SEO Australia, Google Business Australia',
  alternates: {
    canonical: 'https://scalewithdestiny.com/australia',
  },
  openGraph: {
    title: 'Web Design & SEO Services in Australia | Scale With Destiny',
    description: 'Grow your Australian business with professional web design and SEO services. Trusted by businesses from Sydney to Perth.',
    locale: 'en_AU',
    url: 'https://scalewithdestiny.com/australia',
    type: 'website',
    siteName: 'Scale With Destiny',
    images: [
      {
        url: '/og-australia.jpg',
        width: 1200,
        height: 630,
        alt: 'Web Design & SEO Services for Australian Businesses'
      }
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Web Design & SEO Services in Australia',
    description: 'Professional digital solutions for Australian businesses. Free website audit available.',
...
// LocalBusiness Schema for Australia
const localBusinessSchema = {
  '@context': 'https://schema.org',
  '@type': 'ProfessionalService',
  name: 'Scale With Destiny - Australia',
  description: 'Professional web design, SEO optimization, and business setup services for Australian businesses.',
  url: 'https://scalewithdestiny.com/australia',
    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          '@type': 'Service',
          name: 'Web Design Australia',
          description: 'Custom, responsive websites with Australian payment integration'
        }
      },
      {
        '@type': 'Offer',
        itemOffered: {
          ...
          description: 'Local SEO and Google ranking optimization for Australian searches'
        }
      },
      {
        '@type': 'Offer',
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes! We work with businesses across all states and territories - from Sydney to Perth, Melbourne to Brisbane, and everywhere in between.'
      }
    },
    {
      '@type': 'Question',
      name: 'How long does it take to build a website in Australia?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. Our SEO services are specifically designed to rank your business on Google Australia searches with local keyword targeting for Australian audiences.'
      }
    }
  ]
}
...
export default function AustraliaPage() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-2 mb-6">
              ...
              <span className="text-blue-200 font-mono text-sm tracking-wider">🇦🇺 AUSTRALIA</span>
            </div>
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              {['✓ Afterpay Available', '✓ Australian Business Hours', '✓ 24/7 Local Support'].map((badge, i) => (
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/audit">
                <button className="group relative inline-flex items-center gap-2 bg-white text-blue-700 px-8 py-4 rounded-full font-semibold hover:bg-gray-100 transition-all hover:scale-105 shadow-lg">
                  Get Free Australian Business Audit →
      ...
      <section className="py-12 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-8">
            <p className="text-gray-500 text-sm uppercase tracking-wider mb-2">WE SERVE BUSINESSES ACROSS AUSTRALIA</p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { value: '35+', label: 'Australian Businesses Served', icon: <FaRegBuilding className="w-6 h-6" />, color: 'from-blue-500 to-cyan-500' },
              ...
              { value: '24/7', label: 'Australian Support', icon: <FaUsers className="w-6 h-6" />, color: 'from-purple-500 to-pink-500' },
            ].map((stat, i) => (
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-4">
              Complete Digital Solutions for Australian Businesses
            </h2>
            <p className="text-gray-600">
              Tailored services to help your business grow online and attract more local customers across Australia
            </p>
          </div>
      ...
      {/* Why Australia Section - White Background */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-6">
                Why Australian Businesses Trust Scale With Destiny
              </h2>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-100">
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Ready to Grow Your Australian Business?</h3>
                <p className="text-gray-600">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-4">
              Australian Businesses We've Helped
            </h2>
            <p className="text-gray-600">
              Real results from real Australian businesses who trusted us with their digital presence
            </p>
          </div>
          
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { industry: 'Retail', location: 'Sydney', result: '320% increase in online sales with Afterpay', metric: '+320%' },
              { industry: 'Tourism', location: 'Melbourne', result: '#1 on Google for 25+ keywords', metric: '#1 Ranking' },
              { industry: 'Professional Services', location: 'Brisbane', result: '220% traffic growth in 4 months', metric: '+220%' },
            ].map((caseStudy, i) => (
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 mt-2">
              Everything you need to know about our services in Australia
            </p>
          </div>
          
          <div className="space-y-4">
            {[
              { q: 'Do you work with businesses across Australia?', a: 'Yes! We work with businesses across all states and territories - Sydney, Melbourne, Brisbane, Perth, Adelaide, Gold Coast, Canberra, Hobart, and everywhere in between.' },
              ...
              { q: 'Do you accept Afterpay?', a: 'Yes! We offer Afterpay as a payment option for Australian businesses, allowing you to spread payments over 4 installments with 0% interest.' },
              { q: 'Will my website show up on Google Australia?', a: 'Yes. Our SEO services are specifically designed to rank your business on Google Australia searches with local keyword targeting for Australian audiences.' },
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-cyan-500">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ready to Transform Your Australian Business?
          </h2>
          <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
            Join 35+ Australian businesses that have already scaled their digital presence with us.
          </p>
